 ...
 *   <ilg@livius.net>                                                      *
 *                                                                         *
 *   Portions Copyright (C) 2021-2024 Analog Devices, Inc.                 *
 ***************************************************************************/
...
static int armv8_read_reg(struct armv8_common *armv8, int regnum, uint64_t *regval)
{
	...
	if (retval == ERROR_OK && regval)
		*regval = value_64;
	else if (retval == ERROR_TARGET_EXCEPTION_LEVEL && regval)
		*regval = 0xDEADBEEF;
	else
		retval = ERROR_FAIL;
...
static const struct {
	...
	{ ARMV8_SPSR_EL1, "SPSR_EL1", 64, ARMV8_64_EL1H, REG_TYPE_UINT64, "Debug", "net.sourceforge.openocd.debug", NULL},
